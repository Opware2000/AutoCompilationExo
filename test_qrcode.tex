...
% Version Prof
\newif\ifProf
\Proffalse % Mettre \Proftrue pour activer les corrections
...
\qrcode{https://opware2000.github.io/TestGithubPageLatex/test_correction_exercice1.pdf}
\end{center}
...
\begin{Exercice}[Calcul de la dérivée d'une fonction]
\begin{center} Correction\\\vspace*{2mm}
\qrcode{https://opware2000.github.io/TestGithubPageLatex/test_correction_exercice2.pdf}
\end{center}
    % Données de l'exercice
